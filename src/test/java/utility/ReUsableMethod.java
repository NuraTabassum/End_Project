...
public class ReUsableMethod {
	 ...
	 */
	public static void clickObject(WebElement obj1,String objName){
		if(obj1.isDisplayed()){
			obj1.click();
	...
	public static void selectCheckBox(WebElement obj,String objName){
    	...
    	public static void validateMessages(WebElement obj,String expectedText,String objName){
			if(obj.isDisplayed()){
				String actualText=obj.getText().trim();
			if(expectedText.equals(actualText)){
				//System.out.println("Pass : actual message '"+actualText+"' is matching with expected message" );
				logger.log(Status.PASS,("Pass :actual message '"+actualText+"' is matching with expected message"));
			}
			else{
				//System.out.println("Fail : actual Message '" + actualText + "' is not matching with expected message");
			logger.log(Status.FAIL,("Fail : actual Message '" + actualText + "' is not matching with expected message"));
			}
			}else{
				//System.out.println("Fail : " + objName+ " field is not displayed please check your application.");
				logger.log(Status.FAIL,("Fail : "  + objName+ " field is not displayed please check your application."));
			}
		}
